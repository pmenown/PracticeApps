...
/**
 * Created by pmeno on 20/06/2017.
 */
    ...
    public static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++){
                ...
                //extracting the details of each earthquake as per the position of the Features
                // array
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);

                //storing the properties object as a json object
                JSONObject properties  = currentEarthquake.getJSONObject("properties");

                //storing mag as a double.
                ...
                Earthquake earthquake = new Earthquake(magnitude,location,date,earthquakeUrl);
